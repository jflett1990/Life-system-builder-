...
export const CreateProjectBody = zod.object({
  title: zod.string().describe("Short label for the tutorial project"),
  lifeEvent: zod
    .string()
    .describe(
...
export const UpdateProjectBody = zod.object({
  ...
  formattingProfile: zod.string().optional(),
  artifactDensity: zod.string().optional(),
  context: zod.string().optional(),
});
