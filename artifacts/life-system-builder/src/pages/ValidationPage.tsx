          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Checks tutorial structure, prerequisites, checkpoints, cross-stage references, and render readiness.
              </p>
            </div>
            <Button
              size="sm"
            ...
            <div className="flex flex-col items-center gap-4 py-16 border rounded-sm bg-muted/10 text-center">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Run validation to check tutorial outputs for completeness, coherence, and delivery readiness.
                </p>
              </div>
            </div>
          )}
